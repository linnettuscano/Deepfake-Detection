...
app.config["video_uploads"] = "static//Uploaded_videos"
...
@app.route('/comments/<string:vnamez>')
def comments(vnamez):
    vid = Videos.query.filter_by(vname=vnamez).first()

    return render_template('comments.html',v=vid)
